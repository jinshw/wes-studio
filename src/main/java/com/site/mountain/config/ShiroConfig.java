...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        map.put("/sysuser/loginRoles","anon");
        map.put("/sysuser/getAsyncRoutes","anon");
        ...
        map.put("/upload/**","anon");
        map.put("/api/**","anon");
        map.put("/appAccident/**","anon");
        map.put("/fmk/**","anon");
        map.put("/es/**","anon");
        map.put("/hams/**/**","anon");
        map.put("/sysdict/**","anon");
        map.put("/map/api/**","anon");
        map.put("/map/data/**","anon");
        map.put("/mapCar/**","anon");
        map.put("/map/3dtiles/**","anon");
        map.put("/alarm/**","anon");
        map.put("/map/data/list","anon");
        map.put("/map/mecdata/getmap","anon");
        map.put("/test/**","anon");
        map.put("//map/device/selectGltfList","anon");
        map.put("/nt/ibdFactorData/**","anon");
        map.put("/nt/dpInteManage/**","anon");
        map.put("/projectFile/**","anon");
