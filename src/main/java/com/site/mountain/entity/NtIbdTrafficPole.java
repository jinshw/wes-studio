...
public class NtIbdTrafficPole extends BaseNtBean{
    public NtIbdTrafficPole() {
        poiType = "trafficPole";
    }

    public NtIbdTrafficPole(Integer pageSize){
        this.pageSize = pageSize;
    }
    public NtIbdTrafficPole(Integer pageSize, String crossId){
        this.pageSize = pageSize;
    ...
    private List<NtIbdTrafficHld> hldList= new ArrayList<>();
    ...
    public List<NtIbdTrafficHld> getHldList() {
        return hldList;
    }

    public void setHldList(List<NtIbdTrafficHld> hldList) {
