...
public class StandardJsonSliceMethod extends SliceMethod {
    public StandardJsonSliceMethod() {
    }
...
//        JSONObject sourceJson = (JSONObject) JSONObject.parse(sourceJsonStr);
        ...
        JSONObject nodes = mapFrame.getJSONObject("nodes");
...
//        String outJsonStr = messageFrame.toJSONString();
        String outJsonStr = JSON.toJSONString(messageFrame, SerializerFeature.DisableCircularReferenceDetect);
